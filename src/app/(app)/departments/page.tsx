    ...
    try {
      ...
      if (res.success && data) {
        ...
        if (sum && sum.errorCount > 0) {
          ...
          setUploadResult({
            type: "success",
            summary: { successCount: count, errorCount: 0 },
          });
          fetchDepartments();
        }
                  ...
                  <span data-menu>
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        setConfirmAction({
                          open: true,
                          type: dept.isScheduleLocked ? "unlock" : "lock",
                          dept,
                        });
                      }}
                    >
      ...
      >
        ...
        >
          ...
          {uploadResult ? (
              ...
              {uploadResult.type === "success" ? (
                <div className="rounded-lg border border-green-200 bg-green-50 p-4 text-green-800">
                  <p className="font-medium">
                    {uploadResult.summary.successCount} departments created
                    successfully.
                  </p>
                </div>
              ) : (
            ...
            <>
              <div
                className={isUploading ? "opacity-60 pointer-events-none" : ""}
              >
                <div
                  ...
                  onClick={() =>
                    !isUploading &&
                    document.getElementById("dept-csv-input")?.click()
                  }
                >
                  <input
                    id="dept-csv-input"
