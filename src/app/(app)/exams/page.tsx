...
export default function ExamsPage() {
  ...
  const filteredCoursesForCombobox = courses
    .filter((c) => {
              ...
              <tbody>
                {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                  <tr key={i} className="border-t">
                    <td className="p-3">
                      <div className="h-6 bg-gray-200 animate-pulse rounded w-[90px]" />
                    </td>
                    <td className="p-3">
                      <div className="h-6 bg-gray-200 animate-pulse rounded w-[80px]" />
                    </td>
                    <td className="p-3">
                      <div className="h-6 bg-gray-200 animate-pulse rounded w-[140px]" />
                    </td>
                    <td className="p-3">
                    ...
                    <td className="p-3">
                      <div className="h-6 bg-gray-200 animate-pulse rounded w-8" />
                    </td>
                    <td className="p-3">
                      <div className="h-6 bg-gray-200 animate-pulse rounded w-[60px]" />
                    </td>
                      ...
                      <tr key={exam.id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="p-3">
                          <Badge
                            variant="secondary"
                            className={
                              LEVEL_PILL[course?.level ?? ""] ?? "bg-gray-100"
                            }
                          >
            ...
            >
                    ...
                    <FormControl>
                      <div ref={courseComboboxRef} className="relative">
                        <Input
                          ...
                          value={
                            selectedCourse && !courseComboboxQuery
                          ...
                          onKeyDown={(e) =>
                            e.key === "Escape" && setCourseComboboxOpen(false)
                          }
                          disabled={creating}
                        />
              ...
              {isCbt && (
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-3 text-sm text-blue-800 flex items-start gap-2">
                  ...
                  <span>
                    This is a CBT course (100L or General). You must select an
                    ICT venue.
                  </span>
                </div>
              )}
        ...
        >
          ...
          <Form {...editForm}>
            <form
              ...
              className={`space-y-4 transition-opacity ${editLoading ? "opacity-60" : ""}`}
            >
                    ...
                    <FormControl>
                      <div ref={editCourseComboboxRef} className="relative">
                        <Input
                          ...
                          placeholder="Search by code or name..."
                          value={
                            editSelectedCourse && !editCourseComboboxQuery
                              ? courseDisplayLabel(editSelectedCourse)
                              : editCourseComboboxQuery
                          }
                          onChange={(e) => {
                        ...
                        {editCourseComboboxOpen && (
                          <>
                            <div
                              className="fixed inset-0 z-40"
                              aria-hidden
                              onClick={() => setEditCourseComboboxOpen(false)}
                            />
                            <div className="absolute z-50 mt-1 w-full rounded-lg border border-gray-200 bg-white shadow-lg max-h-48 overflow-y-auto">
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {REGULAR_VENUES.map((v) => (
                          <SelectItem key={v} value={v} disabled={editIsCbt}>
                            {VENUE_LABELS[v]}
                          </SelectItem>
                        ))}
                      </SelectContent>
