    ...
    <>
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <div
          className={cn(
            ...
            isMobile
              ? "px-2"
              : "px-2 sm:px-0 sm:flex sm:flex-col sm:items-center lg:items-stretch lg:px-2",
          )}
        >
              ...
              <Link
                ...
                className={cn(
                  ...
                  isMobile
                    ...
                    : "px-3 py-2 sm:justify-center sm:px-0 sm:py-3.5 lg:justify-start lg:py-3 lg:px-4",
                  isActive
      ...
      {user && (
        <div
          className={cn(
            "border-t p-4",
            isMobile ? "hidden" : "hidden lg:block",
          )}
        >
          <Link
            href="/settings"
      ...
      {!user && (
        <div
          className={cn("border-t p-4", isMobile ? "block" : "hidden lg:block")}
        >
          <Link
            href="/login"
